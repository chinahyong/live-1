...
public interface WampCra extends Wamp {
	...
	interface AuthHandler {
        ...
        */
	   void onAuthSuccess(Object permissions);
        ...
        */
	   void onAuthError(String errorUri, String errorDesc);
    }
     ...
     */
	void authenticate(AuthHandler authHandler, String authKey, String authSecret);
     ...
     */
	void authenticate(AuthHandler authHandler, String authKey, String authSecret, Object authExtra);
