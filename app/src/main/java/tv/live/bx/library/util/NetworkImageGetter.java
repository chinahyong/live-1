...
public class NetworkImageGetter implements ImageGetter {
                    ...
                    new ImageLoadingListener() {
                        ...
                        public void onLoadingComplete(Drawable resource) {
                            ...
                            mDrawable.setBounds(0, 0,
                                Utils.px2px(FeizaoApp.mContext, resource.getIntrinsicWidth()),
                                Utils.px2px(FeizaoApp.mContext, resource.getIntrinsicHeight()));
    ...
    private Drawable getEmojiDrawable(String name) {
        ...
        Drawable emojiDrawable = FeizaoApp.mContext.getResources().getDrawable(imageId);
