...
public class LiveTagAdapter extends BaseAdapter {
	...
	public LiveTagAdapter(Context poContext) {
		...
		mImageViewHeight = FeizaoApp.metrics.widthPixels - Utils.dip2px(moContext, 24);
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			loHolder = new Holder();
			loHolder.mItemPhotoLayout = (RelativeLayout) convertView.findViewById(R.id.item_photo_layout);
			LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) loHolder.mItemPhotoLayout.getLayoutParams();
			...
			loHolder.moTvStatus = (ImageView) convertView.findViewById(R.id.item_lv_player_tv_status);
