...
public class LiveNearListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			loHolder.mNearDistance = (TextView) convertView.findViewById(R.id.item_live_near_distance);

			RelativeLayout.LayoutParams lp2 = (RelativeLayout.LayoutParams) loHolder.moIvPhoto.getLayoutParams();
		...
		ImageLoaderUtil.with().loadImageTransformRoundedCorners(moContext, loHolder.moIvPhoto, (String) subjectInfo.get("headPic"), Constants.COMMON_DISPLAY_IMAGE_CORNER_2);
