...
public class SubjectListAdapter extends BaseAdapter {
	...
	public SubjectListAdapter(Context poContext, IOnclickListener cliOnclickListener) {
		moContext = poContext;
	...
	class Holder {
		private ImageView moIvPhoto, mTop, moSupport, mUserLevel;
		private LinearLayout mPictureLayout;
		private RelativeLayout mSupportLayout;
		private TextView moTvNickname, moTvTimer, mTitle, moTvContent, moTvSupport, moTvReply, mTvView, mForumTitle;
	}
