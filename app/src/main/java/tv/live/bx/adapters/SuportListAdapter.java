 ...
 */
public class SuportListAdapter extends BaseAdapter {

	private Context moContext;
	private List<Map<String, Object>> mlPlayers;


	public SuportListAdapter(Context poContext) {
		moContext = poContext;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = loInflater.inflate(R.layout.item_message_suport_list, null);
	...
	class Holder {
		...
		private TextView moTvNickname, moTvTimer;
	}
