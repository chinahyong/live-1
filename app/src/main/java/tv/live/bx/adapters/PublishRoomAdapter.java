...
public class PublishRoomAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		ImageLoaderUtil.with().loadImageTransformRoundedCorners(moContext, loHolder.mMenberLogo, (String) subjectInfo.get("logo"), Constants.COMMON_DISPLAY_IMAGE_CORNER_2);
