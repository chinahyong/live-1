...
public class FansCareAdapter extends MyBaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder = new Holder();
			holder.mFansCareCard = (ImageView) convertView.findViewById(R.id.fans_care_ticket);
			holder.mFansCareHead = (ImageView) convertView.findViewById(R.id.fans_care_headpic);
			holder.mFansCareName = (TextView) convertView.findViewById(R.id.fans_care_name);
			holder.mFansCareLevel = (ImageView) convertView.findViewById(R.id.fans_care_level);
			holder.mFansCareSex = (ImageView) convertView.findViewById(R.id.fans_care_sex);
			holder.mFansCareState = (TextView) convertView.findViewById(R.id.fans_care_state);
		...
		if (!TextUtils.isEmpty(fansLevel)) {
			ImageLoaderUtil.with().loadImage(mContext, holder.mFansCareLevel, Utils.getLevelImageResourceUri(Constants.USER_LEVEL_PIX, fansLevel));
		}
		...
		ImageLoaderUtil.with().loadImageTransformRoundCircle(mContext, holder.mFansCareHead, fansheadPic);
