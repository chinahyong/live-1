...
public class EmojiParser {
	...
	/**
	 * unicode编码转换成"[e]" + value + "[/e]"特定的字符串,如:<e>1f38d</e>
	 */
	...
	public SpannableString addFace(Context context, int imgId, String spannableString) {
		...
		drawable.setBounds(0, 0, (int) context.getResources().getDimension(R.dimen.image_emoji_width),
				(int) (context.getResources().getDimension(R.dimen.image_emoji_width)));
