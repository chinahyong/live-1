 ...
 */
public class MeFanActivity extends BaseFragmentActivity implements OnClickListener {
	...
	private FanExpandableAdapter mFanExpandableAdapter;
	...
	private void initListView(LayoutInflater inflater) {
		...
		mFanExpandableAdapter = new FanExpandableAdapter(mActivity);
				...
				new ExpandableListView.OnChildClickListener() {
					...
					public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
						...
						if (Constants.FAN_STATUS_FREEZE.equals(item.get("status"))) {
							...
							shareInfo.put(ShareDialogActivity.Share_Img, item.get("logo"));
	...
	private void requestPlazaData(int page) {
		BusinessUtils.getMeGroup(mActivity, page, null, new MeFanCallback(this));
	}
	/**
	 * 本地缓存数据加载
	 */
