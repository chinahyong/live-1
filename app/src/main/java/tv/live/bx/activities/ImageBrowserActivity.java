...
public class ImageBrowserActivity extends BaseFragmentActivity implements OnPageChangeListener, OnClickListener {
	...
	public void onClick(View arg0) {
		...
		switch (arg0.getId()) {
			...
			case R.id.image_browser_delete:
				UiHelper.showConfirmDialog(ImageBrowserActivity.this, R.string.sure_delete, R.string.determine,
			...
			case R.id.image_browser_save:
				...
				ImageLoaderUtil.with().loadImage(mActivity, path, ImageSize.SIZE_ORIGINAL, ImageSize.SIZE_ORIGINAL, new SimpleImageLoadingListener() {
					@Override
					public void onLoadingComplete(Drawable resource) {
						if (resource instanceof GlideBitmapDrawable) {
							...
							UiHelper.showToast(mActivity, flag ? getString(R.string.commutity_image_save_success) : getString(R.string.commutity_image_save_fail));
						}
					}
				});
				break;
