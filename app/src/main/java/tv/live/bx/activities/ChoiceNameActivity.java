...
public class ChoiceNameActivity extends BaseFragmentActivity {
	...
	private class OnDetermine implements OnClickListener {
		...
		public void onClick(View arg0) {
			...
			// 1 取值
			// 2 提交信息
			moProgress = Utils.showProgress(ChoiceNameActivity.this);
			BusinessUtils.modifyUserInfo(ChoiceNameActivity.this, new UpdateUserCallbackData(), lsName, UserInfoConfig.getInstance().sex, UserInfoConfig.getInstance().signature,
