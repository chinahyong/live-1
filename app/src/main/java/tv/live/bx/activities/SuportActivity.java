...
import tv.live.bx.adapters.SuportListAdapter;
 ...
 */
public class SuportActivity extends BaseFragmentActivity implements OnClickListener, OnItemClickListener {
	/** 目前暂时都刷新 */
	...
	private SuportListAdapter mReplyAdapter;
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		Map<String, String> lmItem = (Map<String, String>) mReplyAdapter.getItem(position
				- mListView.getHeaderViewsCount());
		if (Constants.SYSTEM_MSG_TYPE_GROUP_POST.equals(lmItem.get("jumpKey"))) {
	...
	protected void initTitleData() {
		mTopTitleTv.setText(R.string.message_me_support);
	...
	private void initListView(LayoutInflater inflater) {
		...
		mReplyAdapter = new SuportListAdapter(mActivity);
	...
	private void requestPlazaData(int page) {
		BusinessUtils.getSystemMsgList(mActivity, new MeMessageCallbackData(this), "support", page);
	}
		...
		public void onCallback(boolean success, String errorCode, String errorMsg, Object result) {
			...
			if (success) {
				try {
					...
					// 下次请求的页面数
					page++;
					SuportActivity fragment = (SuportActivity) mFragment.get();
					// 如果fragment未回收，发送消息
					if (fragment != null)
