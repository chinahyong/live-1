...
public class PackageUtil {
	...
	public static int getVersionCode() {
		int verCode = 0;
		try {
			verCode = App.mContext
                .getPackageManager().getPackageInfo(App.mContext.getPackageName(), 0).versionCode;
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static String getVersionName() {
		...
		try {
			versionName = App.mContext.getPackageManager().getPackageInfo(App.mContext.getPackageName(),
					0).versionName;
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static String getLocalMacAddress() {
		WifiManager wifi = (WifiManager) App.mContext.getSystemService(Context.WIFI_SERVICE);
	...
	public static String getTerminalSign() {
		...
		TelephonyManager tm = (TelephonyManager) App.mContext.getSystemService(Context.TELEPHONY_SERVICE);
	...
	public static String getConfigObject(String key) {
		String val = "";
		try {
			ApplicationInfo appInfo = App.mContext.getPackageManager().getApplicationInfo(
					App.mContext.getPackageName(), PackageManager.GET_META_DATA);
