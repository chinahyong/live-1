package com.bixin.bixin.library.common;
...
/**
 * Title: CrashHandler.java Description: 异常信息处理类，这里会处理未捕捉的异常 Copyright:
 * Copyright (c) 2008
 * @CreateDate 2013-12-2 上午11:00:38
 * @version 1.0
 */
public class CrashHandler implements UncaughtExceptionHandler {
	 ...
	 * 
	 * @param context 上下文
	 * @param crashPath 异常的文件目录
	 */
	public void init(Context context) {
		mContext = context;
		this.mCrashPath = FileUtil.getDiskCachePath(mContext,
				Constants.CRASH_DIR);
	...
	private boolean handleException(Throwable ex) {
		...
		new Thread() {
			...
			public void run() {
				Looper.prepare();
				// Toast.makeText(mContext, R.string.tips_exit_prompt,
