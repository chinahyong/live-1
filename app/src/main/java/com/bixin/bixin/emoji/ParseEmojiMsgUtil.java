...
public class ParseEmojiMsgUtil {
	...
	public static void dealExpression(SpannableString spannableString, Pattern patten, int start)
		...
		while (matcher.find()) {
			...
			if (resId != 0) {
				Drawable drawable = App.mContext.getResources().getDrawable(resId);
				drawable.setBounds(0, 0, (int) (App.mContext.getResources().getDimension(R.dimen.image_emoji_width)),
