...
import com.bixin.bixin.model.PayResult;
...
import com.bixin.bixin.ui.MyWebView.IWebDataInterface;
import com.bixin.bixin.ui.MyWebView.OpenFileChooserCallBack;
...
//			mTopRightText.setText(R.string.shop);
	...
	protected void onNewIntent(Intent intent) {
		if (intent != null) {
			...
			//如果微信支付成功
			if (flag) {
				OperationHelper.onEvent(App.mContext, "theAmountOfRechargeSuccessful", null);
...
//		req.timeStamp = String.valueOf(genTimeStamp());
	...
	public class OnShare implements OnClickListener {
		...
		public void onClick(View v) {
			...
			OperationHelper.onEvent(App.mContext, "clickShareButtonInHtmlPage", null);
	...
	public class gotoStore implements OnClickListener {
		@Override
		public void onClick(View v) {
			OperationHelper.onEvent(App.mContext, "clickStoreInMyBackpackPage", null);
	...
	public class gotoMyBackpack implements OnClickListener {
		@Override
		public void onClick(View v) {
			OperationHelper.onEvent(App.mContext, "clickMyBackpackInStorePage", null);
	...
	public class JsInvokeMainClass {
		...
		public void toPay(final String orderNo) {
			runOnUiThread(new Runnable() {
				@Override
				public void run() {
					OperationHelper.onEvent(App.mContext, "clickWechatModeOfPayment", null);
	...
	public class JsInvokeClass {
		...
		public void alipay(final String payId) {
			runOnUiThread(new Runnable() {
				...
				public void run() {
					showProgressDialog();
					OperationHelper.onEvent(App.mContext, "clickZFBModeOfPayment", null);
