...
import com.bixin.bixin.ui.EmptyRecyclerView;
...
import com.bixin.bixin.ui.drawables.LiveHotDividerDrawable;
		...
		public void onInnerClick(int type, int pos) {
			switch (type) {
				case LiveHotAdapter.CLICK_TOTAL:
					MobclickAgent.onEvent(App.mContext, "clickBbroadcasterSImgInFeatureTab");
					OperationHelper.onEvent(App.mContext, "clickBbroadcasterSImgInFeatureTab", null);
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.focus_layout:
				MobclickAgent.onEvent(App.mContext, "clickmyLovelist");
