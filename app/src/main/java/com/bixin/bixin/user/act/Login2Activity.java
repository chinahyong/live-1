...
import com.bixin.bixin.activities.GetBackPwdActivity;
...
import com.lib.common.network.http.subscriber.RxSubscriber;
...
//		mUserPresenter = new UserPresenter();
	...
	private class OnLogin implements View.OnClickListener {
		...
		public void onClick(View v) {
			MobclickAgent.onEvent(App.mContext, "login");
			// 1 获取用户输入
			...
			Observable<String> observable = mUserPresenter.login(lsUsername, lsPassword);
			observable.subscribeOn(Schedulers.io())
					.observeOn(Schedulers.io())
					.subscribe(new RxSubscriber<String>(Login2Activity.this) {
						@Override
