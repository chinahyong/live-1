...
public class ActionSheetDialog {
	...
	public ActionSheetDialog builder() {
		// 获取Dialog布局
		View view = LayoutInflater.from(context).inflate(R.layout.a_main_dialog_actionsheet_layout, null);
	...
	public ActionSheetDialog setOnCancelListener(OnCancelListener onClickListener) {
