...
public class RippleBackground extends RelativeLayout {
	...
	private void init(final Context context, final AttributeSet attrs) {
		...
		rippleColor = typedArray.getColor(R.styleable.RippleBackground_rb_color, getResources().getColor(R.color.a_bg_color_da500e));
		rippleStrokeWidth = typedArray.getDimension(R.styleable.RippleBackground_rb_strokeWidth, 4);
		rippleRadius = typedArray.getDimension(R.styleable.RippleBackground_rb_radius, 14);
