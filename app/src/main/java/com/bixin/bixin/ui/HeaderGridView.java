/**
 * Project Name:feizao File Name:HeaderGridView.java Package
 * Name:com.efeizao.feizao.ui Date:2016-1-5下午6:19:00
 */

package com.bixin.bixin.ui;

/**
 * ClassName:HeaderGridView Function: TODO ADD FUNCTION. Reason: TODO ADD
 * REASON. Date: 2016-1-5 下午6:19:00
 * @author Live
 * @version 1.0
 */
...
/**
 * * A {@link GridView} that supports adding header rows in a * very similar way
 * to {@link ListView}. * See
...
public class HeaderGridView extends GridView {
	 ...
	 * views. * * @param v The view to add. * @param data Data to associate with
	 * this view * @param isSelectable whether the item is selectable
	 */
	...
	/**
	 * * Removes a previously-added header view. * * @param v The view to remove
