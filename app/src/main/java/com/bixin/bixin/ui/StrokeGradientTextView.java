...
public class StrokeGradientTextView extends StrokeTextView {
	...
	// 字体纵向渐变色
	private final static int GRADIENT_VERTICAL[] = {ContextCompat.getColor(App.mContext, R.color.a_text_color_fff000), ContextCompat.getColor(
        App.mContext, R.color.a_text_color_f99200)};
	...
	protected void init() {
		super.init();
		mTypeface = Typeface.createFromAsset(App.mContext.getAssets(), "font/Sansus Webissimo-Regular.ttf");
