...
public class Constants {
	...
	//图片圆角度
	public static int COMMON_DISPLAY_IMAGE_CORNER_1 = (int) (1 * App.metrics.density);
	public static int COMMON_DISPLAY_IMAGE_CORNER_2 = (int) (2 * App.metrics.density);
	public static int COMMON_DISPLAY_IMAGE_CORNER_3 = (int) (3 * App.metrics.density);
	...
	// 列表图片显示的宽高，为90 dp
	public static final int IMAGE_WIDTH = (int) (80 * App.metrics.density);
	// 列表图片显示的宽高，为90 dp
	public static final int IMAGE_HEIGHT = (int) (80 * App.metrics.density);
	/**
	 * 回复类型1，回复“帖子”
	 */
