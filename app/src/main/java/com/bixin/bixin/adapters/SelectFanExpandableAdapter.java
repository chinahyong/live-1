...
import com.bixin.bixin.library.util.BitmapHelper;
import com.bixin.bixin.library.util.EvtLog;
import com.bixin.bixin.ui.HorizontalListView;
...
public class SelectFanExpandableAdapter extends BaseExpandableListAdapter {
	...
	public void setOnChildClick(OnChildClickListener mOnClick) {
		this.mOnChildClick = mOnClick;
	}
	...
	public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView,
		...
		if (convertView == null) {
			LayoutInflater loInflater = LayoutInflater.from(mContext);
			convertView = loInflater.inflate(R.layout.item_fan_select, null);
			...
			// ((AddHolder) loHolder).mFanPeopleNum = (TextView)
			// convertView.findViewById(R.id.item_fanquan_num);
			((AddHolder) loHolder).mFanHostName = (TextView) convertView.findViewById(R.id.item_fanquan_host_name);
			// ((AddHolder) loHolder).mFanLock = (ImageView)
			// convertView.findViewById(R.id.item_fanquan_lock);
			// ((AddHolder) loHolder).mFanInvite = (ImageView)
			// convertView.findViewById(R.id.item_fanquan_invite);
		...
		convertView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				mOnChildClick.onChildClick(groupPosition, childPosition);
			}
		});
	...
	private void setFanCreate(final int groupPosition, final int childPosition, Holder loHolder) {
		...
		if (Constants.FAN_STATUS_FREEZE.equals(item.get("status"))) {
			...
			// mContext.getResources().getString(R.string.commutity_fan_unlock_text),
			// item.get("memberTotal"),
			...
			// ((AddHolder) loHolder).mFanPeopleNum.setText((String)
			// item.get("memberTotal") + "人");
			// ((AddHolder)
	...
	class AddHolder extends Holder {
		...
		TextView mFanName, mFanHostName;
	}
