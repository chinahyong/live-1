    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            loHolder.moTvNickname = (TextView) convertView
                .findViewById(R.id.item_lv_manager_nickname);
        ...
        @SuppressWarnings("unchecked")        final Map<String, Object> lmItem = (Map<String, Object>) getItem(
            position);
        ...
        if (!TextUtils.isEmpty((String) lmItem.get("level"))) {
            ImageLoaderUtil.getInstance().loadImage(loHolder.mUserLevel, Utils
                .getLevelImageResourceUri(Constants.USER_LEVEL_PIX, (String) lmItem.get("level")));
        }
        // 取消管理
