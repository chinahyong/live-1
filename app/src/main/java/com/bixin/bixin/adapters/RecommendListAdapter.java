	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		loHolder.moCkChoose.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				if (isChecked) {
					MobclickAgent.onEvent(App.mContext,"clickChooseFollowInRecommendBroadcasterPage");
					checkFlagMap.put(position, String.valueOf(lmRoom.get("mid")));
				} else {
					MobclickAgent.onEvent(App.mContext,"clickCancelFollowInRecommendBroadcasterPage");
