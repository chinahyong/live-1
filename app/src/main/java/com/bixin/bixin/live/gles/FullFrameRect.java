...
import com.bixin.bixin.live.filter.IFilter;
...
public class FullFrameRect {
    ...
    public void changeProgram(IFilter newFilter) {
        Log.e("FBO", "changeProgram newFilter:" + newFilter.toString());
        mFilter.releaseProgram();
        Log.e("FBO", "changeProgram newFilter:xxxx" + newFilter.toString());
        mFilter = newFilter;
    }
