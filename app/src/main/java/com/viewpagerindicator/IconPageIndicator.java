...
public class IconPageIndicator extends HorizontalScrollView implements PageIndicator {
	...
	public IconPageIndicator(Context context, AttributeSet attrs) {
		...
		mMarginLeft = (int) a.getDimension(R.styleable.IconPageIndicator_LLmarginLeft, 10);
		mMarginRight = (int) a.getDimension(R.styleable.IconPageIndicator_LLmarginRight, 10);
