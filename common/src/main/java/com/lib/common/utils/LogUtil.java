...
//        IS_DEBUG_LOGGABLE = BuildConfig.debug_log_enable;
//        IS_ERROR_LOGGABLE = BuildConfig.error_log_enable;
	...
	public static void d(String tag, String msg, boolean isDisk) {
		...
		if (isDisk) {
			...
			Logger.d(tag, formatLogToString(tag, msg));
	...
	static boolean isNetworkException(Throwable exception) {
		...
		return exception instanceof BindException || exception instanceof ConnectException
