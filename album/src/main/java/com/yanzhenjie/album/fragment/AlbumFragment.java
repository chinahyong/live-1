 ...
 */
public class AlbumFragment extends BasicCameraFragment implements View.OnClickListener {
...
//		displayHomeAsUpEnabled(R.drawable.a_common_btn_back_selector);

		mTopLeft = (RelativeLayout) view.findViewById(R.id.toolbar_left_layout);
		mTopRight = (TextView) view.findViewById(R.id.toolbar_right);
...
//		setTitle(title);
//		getToolbar().setTitleTextColor(getResources().getColor(R.color.a_font_color_333333));
//		setTitle("");
